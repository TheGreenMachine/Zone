...
//        elevatorCancoder = factory.getCanCoder(NAME, "Elevator", factory.getConstant(NAME, "canCoderOffset", -0.5));
    ...
    /**
     * Sets the desired state of the roller, feeder, and elevator
     *
     */
    public void setDesiredState() {
        setDesiredState(this.desiredElevatorState);
    }
    ...
    public void readFromHardware() {
        SmartDashboard.putNumber("ActualDegrees", actualElevatorDegrees);

        actualElevatorPosition = elevatorMotor.getSensorPosition();
//        actualElevatorDegrees = (elevatorCancoder.getPosition().getValueAsDouble() / Constants.cancoderRotationsPerDegree);
        elevatorCurrentDraw = elevatorMotor.getMotorOutputCurrent();

        if (robotState.actualElevatorState == ELEVATOR_STATE.GROUND) {
...
//        elevatorCancoder.setPosition(0, 50);
    }
