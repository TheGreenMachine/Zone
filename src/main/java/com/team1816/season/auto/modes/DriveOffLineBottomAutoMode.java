...
public class DriveOffLineBottomAutoMode extends AutoMode {

    public DriveOffLineBottomAutoMode(Color color, FieldPlacement fieldPlacement) {
        super(
                List.of(
                        new TrajectoryAction(
                                new DriveOffLineBottomPath(color, fieldPlacement)
                        )
                )
        );
    }
