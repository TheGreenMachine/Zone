...
public class AlgaeCatcherAction implements AutoAction {
    ...
    private AlgaeCatcher.ALGAE_CATCHER_INTAKE_STATE desiredCatcherState;
    private AlgaeCatcher.ALGAE_CATCHER_POSITION_STATE desiredPositionState;

    public AlgaeCatcherAction(AlgaeCatcher.ALGAE_CATCHER_INTAKE_STATE desiredCatcherState, AlgaeCatcher.ALGAE_CATCHER_POSITION_STATE desiredPositionState) {
