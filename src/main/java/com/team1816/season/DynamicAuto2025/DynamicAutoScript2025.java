...
public class DynamicAutoScript2025 {
    ...
    public DynamicAutoScript2025(int numOfTrajectoryActions){
        ...
        addTrajectoryOption("Hex 6 Blue", new Pose2d(new Translation2d(3.799672, 5.210954), Rotation2d.fromDegrees(320)));
        ...
        addTrajectoryOption("Hex 6 Red", new Pose2d(new Translation2d(12.344598, 5.307781), Rotation2d.fromDegrees(320)));
